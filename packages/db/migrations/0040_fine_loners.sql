...
ALTER TABLE "system_billing_tier" ADD CONSTRAINT "system_billing_tier_access_code_check" CHECK ("system_billing_tier"."access_code" is null or (not "system_billing_tier"."is_public" and "system_billing_tier"."access_code" = btrim("system_billing_tier"."access_code") and length("system_billing_tier"."access_code") between 16 and 128));--> statement-breakpoint
ALTER TABLE "system_billing_tier" ADD CONSTRAINT "system_billing_tier_workflow_execution_time_limit_check" CHECK ("system_billing_tier"."workflow_execution_time_limit_seconds" is null or "system_billing_tier"."workflow_execution_time_limit_seconds" between 1 and 2147483);