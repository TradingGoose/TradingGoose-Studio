...
{{- end }}
{{- if and (or .Values.app.enabled .Values.realtime.enabled) (not .Values.app.env.INTERNAL_API_SECRET) }}
{{- fail "app.env.INTERNAL_API_SECRET is required for internal service authentication" }}
{{- end }}
