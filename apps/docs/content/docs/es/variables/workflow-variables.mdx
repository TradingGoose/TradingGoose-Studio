...
Cuando escribes `<` en un campo de texto, aparece un menú desplegable con todas las variables disponibles del flujo de trabajo. Selecciona la que necesites para insertar una referencia.
...
Las variables en TradingGoose pueden almacenar varios tipos de datos:
