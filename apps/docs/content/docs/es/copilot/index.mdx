...
Copilot es tu asistente integrado en el editor que te ayuda a crear y editar flujos de trabajo con TradingGoose Copilot, así como a entenderlos y mejorarlos. Puede:

- **Explicar**: Responder preguntas sobre TradingGoose y tu flujo de trabajo actual
...
<Callout type="info">
  Copilot es un servicio gestionado por TradingGoose. Para implementaciones autoalojadas, genera una clave API de Copilot en la aplicación alojada (tradinggoose.ai → Configuración → Copilot)
  1. Ve a [tradinggoose.ai](https://tradinggoose.ai) → Configuración → Copilot y genera una clave API de Copilot
...
- **Chats**: Consulta conversaciones previas con el copiloto
- **Todos los flujos de trabajo**: Consulta cualquier flujo de trabajo en tu espacio de trabajo
- **Bloques de flujo de trabajo**: Consulta bloques específicos de los flujos de trabajo
- **Bloques**: Consulta tipos de bloques y plantillas
- **Conocimiento**: Consulta tus documentos subidos y base de conocimientos
- **Documentación**: Consulta la documentación de TradingGoose
- **Plantillas**: Consulta plantillas de flujos de trabajo
- **Registros**: Consulta registros de ejecución y resultados
