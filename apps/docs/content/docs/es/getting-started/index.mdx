...
Este tutorial te guiará en la creación de tu primer flujo de trabajo de IA en TradingGoose. Crearemos un agente de investigación de personas que puede encontrar información sobre individuos utilizando herramientas de búsqueda LLM de última generación.

<Callout type="info">
  Este tutorial dura aproximadamente 10 minutos y cubre los conceptos esenciales para crear flujos de trabajo en TradingGoose.
</Callout>
...
<Steps>
  <Step title="Crear flujo de trabajo y añadir agente de IA">
    Abre TradingGoose y haz clic en "Nuevo flujo de trabajo" en el panel de control. Nómbralo "Primeros pasos".
