...
Para invitar a alguien, abre la configuración del espacio de trabajo y selecciona la pestaña **Members**. Haz clic en **Invite**, añade al nuevo miembro por correo electrónico y elige su nivel de permisos (Read, Write o Admin).
...
- Si una variable personal tiene el mismo nombre que una variable del espacio de trabajo, tiene prioridad la variable del espacio de trabajo
