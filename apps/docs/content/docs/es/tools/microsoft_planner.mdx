...
| --------- | ---- | -------- | ----------- |
| `planId` | string | No | El ID del plan del que obtener las tareas \(si no se proporciona, obtiene todas las tareas del usuario\) |
  ...
  <BlockConfigPreview
    ...
    subBlocks={[
        ...
        },
        {
            ...
            "title": "ID del Plan",
            "layout": "full",
            "placeholder": "Ingresar el ID del plan"
        },
        {
            "id": "title",
            "type": "short-input",
            ...
            "layout": "full",
            "placeholder": "Ingresar el título de la tarea"
        },
        {
            "id": "description",
            "type": "long-input",
            "title": "Descripción",
            "layout": "full",
            "placeholder": "Ingresar descripción de la tarea (opcional)"
        },
        {
            "id": "dueDateTime",
            "type": "datetime-input",
            ...
            "layout": "full",
            "placeholder": "Ingresar fecha de vencimiento en formato 2024-12-31 23:59:59"
        },
        {
            "id": "assigneeUserId",
            "type": "short-input",
            ...
            "layout": "full",
            "placeholder": "Ingresar el ID de usuario al que asignar esta tarea (opcional)"
        },
        {
            "id": "bucketId",
            "type": "short-input",
            "title": "ID del Bucket",
            "layout": "full",
            "placeholder": "Ingresar el ID del bucket para organizar la tarea (opcional)"
        }
    ]}
  />
</ShowcaseCard>
...
Crea una nueva tarea en Microsoft Planner
...
| `assigneeUserId` | string | No | El ID de usuario al que se asignará la tarea |
| `bucketId` | string | No | El ID del bucket donde se colocará la tarea |

<div className="text-sm font-medium text-fd-muted-foreground mt-4 mb-2">Salida</div>

| Parámetro | Tipo | Descripción |
| --------- | ---- | ----------- |
| `success` | boolean | Indica si la tarea fue creada exitosamente |
...
Integra Microsoft Planner en el flujo de trabajo. Permite leer y crear tareas.
