---
title: MySQL
description: Conectar a base de datos MySQL
---
  ...
  <BlockConfigPreview
    ...
    subBlocks={[
        ...
        },
        {
            ...
            "title": "Host",
            "layout": "full",
            "placeholder": "localhost o su.host.de.base.de.datos",
            "required": true
        },
        {
            "id": "port",
  ...
  <BlockConfigPreview
    ...
    subBlocks={[
        ...
        },
        {
            ...
            "title": "Contraseña",
            "layout": "full",
            "placeholder": "Tu contraseña de base de datos",
            "password": true,
            "required": true
        },
        {
...
| `host` | string | Sí | Nombre de host o dirección IP del servidor MySQL |
| `port` | number | Sí | Puerto del servidor MySQL \(predeterminado: 3306\) |
| `database` | string | Sí | Nombre de la base de datos a conectar |
| `username` | string | Sí | Nombre de usuario de la base de datos |
| `password` | string | Sí | Contraseña de la base de datos |
| `ssl` | string | No | Modo de conexión SSL \(disabled, required, preferred\) |
...
Ejecutar consulta SQL sin procesar en una base de datos MySQL
...
| `port` | number | Sí | Puerto del servidor MySQL \(predeterminado: 3306\) |
| `database` | string | Sí | Nombre de la base de datos a la que conectarse |
| `username` | string | Sí | Usuario de la base de datos |
| `password` | string | Sí | Contraseña de la base de datos |
| `ssl` | string | No | Modo de conexión SSL \(disabled, required, preferred\) |
...
Integre MySQL en el flujo de trabajo. Permite consultar, insertar, actualizar, eliminar y ejecutar SQL sin procesar.
