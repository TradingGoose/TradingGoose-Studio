...
| --------- | ---- | -------- | ----------- |
| `spreadsheetId` | string | Sí | El ID de la hoja de cálculo desde la que leer |
| `range` | string | No | El rango de celdas a leer. Acepta "SheetName!A1:B2" para rangos explícitos o simplemente "SheetName" para leer el rango utilizado de esa hoja. Si se omite, lee el rango utilizado de la primera hoja. |
  ...
  <BlockConfigPreview
    ...
    subBlocks={[
        ...
        },
        {
            ...
            "layout": "full",
            "placeholder": "Ingresar ID de la hoja de cálculo"
        },
        {
            "id": "range",
            "type": "short-input",
        ...
        },
        {
            ...
            "title": "Valores",
            "layout": "full",
            "placeholder": "Ingresar valores como array JSON de arrays (p. ej., [[\"A1\", \"B1\"], [\"A2\", \"B2\"]]) o un array de objetos (p. ej., [{\"name\":\"John\", \"age\":30}, {\"name\":\"Jane\", \"age\":25}])",
            "required": true
        },
        {
            "id": "valueInputOption",
            ...
            "options": [
                {
                    "label": "Ingresado por Usuario (Procesar fórmulas)",
                    "id": "USER_ENTERED"
                }
            ]
        }
...
Escribe datos en una hoja de cálculo de Microsoft Excel
...
| `tableName` | string | Sí | El nombre de la tabla a la que se agregarán filas |
| `values` | array | Sí | Los datos a agregar a la tabla \(array de arrays u array de objetos\) |
...
| `values` | array | Array de filas que se agregaron a la tabla |
| `spreadsheetId` | string | El ID de la hoja de cálculo |
...
Integre Microsoft Excel en el flujo de trabajo. Puede leer, escribir, actualizar y agregar datos a una tabla.
