...
Las herramientas son componentes potentes en TradingGoose que permiten a tus flujos de trabajo interactuar con servicios externos, procesar datos y realizar tareas especializadas. Amplían las capacidades de tus agentes y flujos de trabajo proporcionando acceso a varias APIs y servicios.
...
TradingGoose proporciona una colección diversa de herramientas para varios propósitos, incluyendo:
