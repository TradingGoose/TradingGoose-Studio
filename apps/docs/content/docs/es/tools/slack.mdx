...
<iframe
  ...
  title="Integración de Slack con TradingGoose"
  frameBorder="0"
...
- **Automatizar notificaciones de agentes**: Enviar actualizaciones en tiempo real desde tus agentes TradingGoose a cualquier canal de Slack
- **Crear endpoints de webhook**: Configurar bots de Slack como webhooks para activar flujos de trabajo de TradingGoose desde actividades de Slack
...
En TradingGoose, la integración con Slack permite a tus agentes interactuar programáticamente con Slack de varias maneras como parte de sus flujos de trabajo:
