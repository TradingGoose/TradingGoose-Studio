    ...
    subBlocks={[
        {
            ...
            "layout": "full",
            "placeholder": "Ingrese el texto para generar embeddings",
            "required": true
        },
        {
            "id": "model",
...
Genera embeddings a partir de texto utilizando OpenAI
...
| `embeddings` | array | Array de vectores de embedding |
