...
TradingGoose es un constructor visual de flujos de trabajo para aplicaciones de IA que te permite crear flujos de trabajo de agentes de IA de forma visual. Crea agentes de IA potentes, flujos de trabajo de automatización y pipelines de procesamiento de datos conectando bloques en un lienzo—sin necesidad de código.

<div className="flex justify-center">
  <Image
    src="/static/introduction.png"
    alt="Lienzo visual de flujos de trabajo de TradingGoose"
    width={700}
    height={450}
    className="my-6"
  />
...
**Alojado en la nube**: Comienza al instante en [tradinggoose.ai](https://tradinggoose.ai) con infraestructura gestionada, escalado automático y monitorización integrada.
