...
TradingGoose calcula automáticamente los costos de todas las ejecuciones de flujos de trabajo, proporcionando precios transparentes basados en el uso de modelos de IA y cargos de ejecución. Entender estos costos te ayuda a optimizar los flujos de trabajo y gestionar tu presupuesto de manera efectiva.
...
La barra lateral de detalles del registro incluye una sección de desglose por modelo que muestra:
...
<Tabs items={['Modelos alojados', 'Trae tu propia clave API']}>
  <Tab>
    **Modelos alojados** - TradingGoose proporciona claves API con un multiplicador de precio de 2,5x:
...
|------|-------------------|-------------------------|
| **Gratuito** | $10 | 10 síncronos, 50 asíncronos |
| **Pro** | $20 | 25 síncronos, 200 asíncronos |
| **Equipo** | $40/puesto (agrupado) | 75 síncronos, 500 asíncronos |
| **Empresa** | Personalizado | 150 síncronos, 1000 asíncronos |

## Modelo de facturación

TradingGoose usa un modelo de **suscripción base + exceso de uso**:

### Funcionamiento

**Plan Pro ($20/mes):**
- Incluye $20 de uso al mes
- Uso inferior a $20 → Sin cargos adicionales
- Uso superior a $20 → El exceso se cobra al finalizar el mes
- Ejemplo: $35 de usage = $20 de suscripción + $15 de exceso
...
Cuando el exceso no facturado alcanza los 50$, TradingGoose factura automáticamente el monto total no facturado.
