...
El motor de ejecución de TradingGoose da vida a tus flujos de trabajo procesando bloques en el orden correcto, gestionando el flujo de datos y manejando errores con elegancia, para que puedas entender exactamente cómo se ejecutan los flujos de trabajo en TradingGoose.
...
Cuando despliegas un flujo de trabajo como API, TradingGoose:
- Crea un punto de conexión HTTP único: `https://tradinggoose.ai/api/workflows/{workflowId}/execute`
...
- Alojado en un subdominio personalizado: `https://your-name.tradinggoose.ai`
...
El modal Deploy conserva un historial completo en una tabla de instantáneas de despliegue. Puedes inspeccionar cualquier instantánea, compararla con tu borrador y promoverla o revertirla con un clic cuando necesites restaurar una versión anterior.
...
- Almacena resultados en caché con bloques Variables cuando sea apropiado
