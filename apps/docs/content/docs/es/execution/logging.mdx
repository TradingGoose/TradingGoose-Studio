...
TradingGoose proporciona un registro completo para todas las ejecuciones de flujos de trabajo, dándote visibilidad total sobre cómo se ejecutan tus flujos de trabajo, qué datos fluyen a través de ellos y dónde podrían ocurrir problemas.
...
El panel Consola aparece en el lado derecho del editor de flujos de trabajo y muestra:
...
Al hacer clic en cualquier entrada de registro se abre una barra lateral detallada con la cronología de ejecución, los detalles de cada bloque y el resumen de costos.
...
Para cualquier ejecución registrada, haz clic en "View Snapshot" para ver el estado exacto del flujo de trabajo en el momento de la ejecución. La instantánea proporciona:
