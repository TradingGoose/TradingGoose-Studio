...
Simplemente carga tus documentos para comenzar. TradingGoose los procesa automáticamente en segundo plano, extrayendo texto, creando incrustaciones y dividiéndolos en fragmentos buscables.
...
Después de procesar los documentos, puedes ver y editar cada fragmento. Así controlas cómo se organiza y busca el contenido. La vista muestra el texto de cada fragmento, su índice dentro del documento y las etiquetas asociadas.
...
Una vez procesados los documentos, puedes utilizarlos en workflows de IA mediante el bloque Knowledge. Este bloque habilita la generación aumentada por recuperación (RAG), para que los agentes accedan al contenido de los documentos y razonen sobre él. Añade un bloque Knowledge al workflow, selecciona una base de conocimiento y configura la consulta y los filtros de etiquetas opcionales.
...
TradingGoose utiliza búsqueda vectorial impulsada por [pgvector](https://github.com/pgvector/pgvector) para entender el significado y contexto de tu contenido:
