...
Los webhooks permiten que servicios externos activen la ejecución de flujos de trabajo desde webhooks externos mediante el envío de solicitudes HTTP a tu flujo de trabajo. TradingGoose admite dos enfoques para los disparadores basados en webhooks.
