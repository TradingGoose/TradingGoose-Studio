    ...
    subBlocks={[
        {
            ...
            "description": "Seleccione eventos específicos de Stripe para filtrar. Dejar vacío para recibir todos los eventos de Stripe.",
            "options": [
                {
        ...
        },
        {
            ...
            "placeholder": "whsec_...",
            "description": "Su secreto de firma del webhook obtenido desde el Panel de Stripe. Se utiliza para verificar la autenticidad del webhook.",
            "password": true
        }
    ]}
  />
...
<SchemaTree
  ...
  fields={[
      ...
      },
      {
          "name": "api_version",
          "type": "string",
          "description": "Versión de la API de Stripe utilizada para renderizar el evento"
      },
      {
          "name": "created",
          "type": "number",
          "description": "Marca de tiempo Unix de cuando se creó el evento"
      },
      {
          "name": "data",
          "type": "json",
      ...
      },
      {
          "name": "livemode",
          "type": "boolean",
          "description": "Indica si el evento ocurrió en modo en vivo (true) o en modo de prueba (false)"
      },
      {
      ...
      },
      {
          "name": "request",
          "type": "json",
          "description": "Información sobre la solicitud que desencadenó este evento"
      }
  ]}
/>
