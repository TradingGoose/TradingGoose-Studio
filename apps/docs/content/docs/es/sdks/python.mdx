...
El SDK oficial de Python para TradingGoose te permite ejecutar flujos de trabajo programáticamente desde tus aplicaciones Python utilizando el SDK oficial de Python.
...
**Parámetros:**
- `api_key` (str): Tu clave API de TradingGoose
- `base_url` (str, opcional): URL base para la API de TradingGoose
