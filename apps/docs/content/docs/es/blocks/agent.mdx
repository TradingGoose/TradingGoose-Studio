...
Un Agent puede usar un arreglo de mensajes existente de `<memory.memories>` en el campo Memories. Sin embargo, Add del bloque Memory falla actualmente, por lo que el flujo guardar mensaje → Agent → guardar respuesta no es operativo. Revisa la [limitación de Memory](/blocks/memory) antes de diseñar persistencia entre ejecuciones.
...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    <li>El usuario envía un ticket de soporte mediante el disparador API</li>
    ...
    <li>Usa almacenamiento persistente para el historial; Memory Add no está disponible actualmente</li>
  </ol>
</div>
