...
El bloque Paralelo es un bloque contenedor en TradingGoose que permite ejecutar múltiples instancias de bloques simultáneamente para un procesamiento más rápido del flujo de trabajo.
