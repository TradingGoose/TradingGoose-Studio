---
title: Variables
description: Define y gestiona variables del workflow
---
...
<BlockInfoCard type="variables" color="#8B5CF6" />
...
<ShowcaseCard>
  <BlockConfigPreview
    ...
    hideHeader
    subBlocks={[
      { "id": "variables", "title": "Variable Assignments", "type": "variables-input", "layout": "full", "description": "Selecciona variables del workflow y actualiza sus valores durante la ejecución. Accede a ellas desde cualquier lugar con la sintaxis <variable.variableName>." }
    ]}
  />
</ShowcaseCard>
