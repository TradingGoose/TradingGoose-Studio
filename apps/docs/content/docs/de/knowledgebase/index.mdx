...
Laden Sie einfach Ihre Dokumente hoch, um zu beginnen. TradingGoose verarbeitet sie automatisch im Hintergrund, extrahiert Text, erstellt Embeddings und teilt sie in durchsuchbare Chunks auf.
...
Für PDF-Dokumente bietet TradingGoose erweiterte Verarbeitungsfunktionen:
...
TradingGoose verwendet Vektorsuche, die von [pgvector](https://github.com/pgvector/pgvector) unterstützt wird, um die Bedeutung und den Kontext Ihrer Inhalte zu verstehen:
