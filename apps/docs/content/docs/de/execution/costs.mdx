...
TradingGoose berechnet automatisch die Kosten für alle Workflow-Ausführungen und bietet transparente Preise basierend auf der Nutzung von KI-Modellen und Ausführungsgebühren. Das Verständnis dieser Kosten hilft Ihnen, Workflows zu optimieren und Ihr Budget effektiv zu verwalten.
...
<Tabs items={['Gehostete Modelle', 'Eigener API-Schlüssel']}>
  <Tab>
    **Gehostete Modelle** - TradingGoose stellt API-Schlüssel mit einem 2,5-fachen Preismultiplikator bereit:
...
- Überprüfen Sie Ihre aktuelle Nutzung unter [Einstellungen → Abonnement](https://tradinggoose.ai/settings/subscription)
...
Wenn die nicht abgerechnete Überschreitung 50 $ erreicht, berechnet TradingGoose automatisch den gesamten nicht abgerechneten Betrag.
