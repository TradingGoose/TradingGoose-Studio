...
Die Ausführungs-Engine von TradingGoose bringt Ihre Workflows zum Leben, indem sie Blöcke in der richtigen Reihenfolge verarbeitet, den Datenfluss verwaltet und Fehler elegant behandelt, sodass Sie genau verstehen können, wie Workflows in TradingGoose ausgeführt werden.
...
Wenn Sie einen Workflow als API bereitstellen, macht TradingGoose Folgendes:
- Erstellt einen eindeutigen HTTP-Endpunkt: `https://tradinggoose.ai/api/workflows/{workflowId}/execute`
...
- Gehostet auf einer benutzerdefinierten Subdomain: `https://your-name.tradinggoose.ai`
