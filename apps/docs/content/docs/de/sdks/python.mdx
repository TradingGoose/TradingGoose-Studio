...
Das offizielle Python SDK für TradingGoose ermöglicht es Ihnen, Workflows programmatisch aus Ihren Python-Anwendungen mithilfe des offiziellen Python SDKs auszuführen.
...
**Parameter:**
- `api_key` (str): Ihr TradingGoose API-Schlüssel
- `base_url` (str, optional): Basis-URL für die TradingGoose API
    ...
    def generate():
        response = requests.post(
            ...
            headers={
                ...
                'X-API-Key': os.getenv('TRADINGGOOSE_API_KEY')
            },
            json={
...
<Steps>
  <Step title="Bei TradingGoose anmelden">
    Navigiere zu [TradingGoose](https://tradinggoose.ai) und melde dich bei deinem Konto an.
  </Step>
