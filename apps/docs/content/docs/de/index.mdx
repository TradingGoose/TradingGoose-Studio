...
# TradingGoose Dokumentation

Willkommen bei TradingGoose, einem visuellen Workflow-Builder für KI-Anwendungen. Erstellen Sie leistungsstarke KI-Agenten, Automatisierungs-Workflows und Datenverarbeitungs-Pipelines, indem Sie Blöcke auf einer Leinwand verbinden.

## Schnellstart

<Cards>
  <Card title="Einführung" href="/introduction">
    Erfahren Sie, was Sie mit TradingGoose erstellen können
  </Card>
...
<Cards>
  ...
  <Card title="SDKs" href="/sdks">
    Integrieren Sie TradingGoose in Ihre Anwendungen
  </Card>
</Cards>