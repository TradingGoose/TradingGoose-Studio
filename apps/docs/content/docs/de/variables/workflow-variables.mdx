...
Variablen in TradingGoose können verschiedene Arten von Daten speichern:
...
Variablen in TradingGoose haben einen globalen Geltungsbereich, das bedeutet:
