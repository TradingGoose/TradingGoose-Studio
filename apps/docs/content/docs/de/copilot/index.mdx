...
Copilot ist dein Assistent im Editor, der dir hilft, Workflows mit TradingGoose Copilot zu erstellen und zu bearbeiten sowie diese zu verstehen und zu verbessern. Er kann:

- **Erklären**: Beantwortet Fragen zu TradingGoose und deinem aktuellen Workflow
...
<Callout type="info">
  Copilot ist ein von TradingGoose verwalteter Dienst. Für selbst gehostete Installationen generiere einen Copilot API-Schlüssel in der gehosteten App (tradinggoose.ai → Einstellungen → Copilot)
  1. Gehe zu [tradinggoose.ai](https://tradinggoose.ai) → Einstellungen → Copilot und generiere einen Copilot API-Schlüssel
...
- **Chats**: Frühere Copilot-Gespräche einsehen
- **Alle Workflows**: Auf jeden Workflow in deinem Arbeitsbereich zugreifen
- **Workflow-Blöcke**: Auf bestimmte Blöcke aus Workflows zugreifen
- **Blöcke**: Auf Blocktypen und Vorlagen zugreifen
- **Wissen**: Auf deine hochgeladenen Dokumente und Wissensdatenbank zugreifen
- **Dokumentation**: Auf die TradingGoose-Dokumentation zugreifen
- **Vorlagen**: Auf Workflow-Vorlagen zugreifen
- **Protokolle**: Auf Ausführungsprotokolle und Ergebnisse zugreifen
