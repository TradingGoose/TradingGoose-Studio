...
Dieses Tutorial führt dich durch den Aufbau deines ersten KI-Workflows in TradingGoose. Wir erstellen einen Personen-Recherche-Agenten, der Informationen über Personen mithilfe modernster LLM-Suchwerkzeuge finden kann.

<Callout type="info">
  Dieses Tutorial dauert etwa 10 Minuten und behandelt die wesentlichen Konzepte zum Erstellen von Workflows in TradingGoose.
</Callout>
...
<Steps>
  <Step title="Workflow erstellen und KI-Agenten hinzufügen">
    Öffne TradingGoose und klicke im Dashboard auf "Neuer Workflow". Benenne ihn "Erste Schritte".
