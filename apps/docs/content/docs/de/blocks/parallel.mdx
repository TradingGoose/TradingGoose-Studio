...
Der Parallel-Block ist ein Container-Block in TradingGoose, der es ermöglicht, mehrere Instanzen von Blöcken gleichzeitig auszuführen, um Workflows schneller zu verarbeiten.
