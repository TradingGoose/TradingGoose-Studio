...
Copilot est votre assistant intégré à l'éditeur qui vous aide à créer et à modifier des flux de travail avec TradingGoose Copilot, ainsi qu'à les comprendre et à les améliorer. Il peut :

- **Expliquer** : répondre aux questions sur TradingGoose et votre flux de travail actuel
...
<Callout type="info">
  Copilot est un service géré par TradingGoose. Pour les déploiements auto-hébergés, générez une clé API Copilot dans l'application hébergée (tradinggoose.ai → Paramètres → Copilot)
  1. Allez sur [tradinggoose.ai](https://tradinggoose.ai) → Paramètres → Copilot et générez une clé API Copilot
...
- **Chats** : Consulter les conversations précédentes avec le copilote
- **Tous les workflows** : Consulter tous les workflows dans votre espace de travail
- **Blocs de workflow** : Consulter des blocs spécifiques des workflows
- **Blocs** : Consulter les types de blocs et les modèles
- **Connaissances** : Consulter vos documents téléchargés et votre base de connaissances
- **Docs** : Consulter la documentation TradingGoose
- **Modèles** : Consulter les modèles de workflow
- **Journaux** : Consulter les journaux d'exécution et les résultats
