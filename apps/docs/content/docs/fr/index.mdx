...
# Documentation TradingGoose

Bienvenue sur TradingGoose, un constructeur visuel de flux de travail pour les applications d'IA. Créez des agents IA puissants, des flux d'automatisation et des pipelines de traitement de données en connectant des blocs sur un canevas.

## Démarrage rapide

<Cards>
  <Card title="Introduction" href="/introduction">
    Découvrez ce que vous pouvez construire avec TradingGoose
  </Card>
  ...
  <Card title="Blocs de flux de travail" href="/blocks">
    Apprenez-en plus sur les éléments de construction
  </Card>
...
<Cards>
  ...
  <Card title="SDKs" href="/sdks">
    Intégrer TradingGoose dans vos applications
  </Card>
</Cards>