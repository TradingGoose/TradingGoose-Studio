...
Les variables dans TradingGoose peuvent stocker différents types de données :
...
Les variables dans TradingGoose ont une portée globale, ce qui signifie :
