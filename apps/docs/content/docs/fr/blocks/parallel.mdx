...
Le bloc Parallel est un bloc conteneur dans TradingGoose qui permet d'exécuter plusieurs instances de blocs simultanément pour un traitement de flux de travail plus rapide.
