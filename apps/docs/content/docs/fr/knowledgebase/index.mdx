...
Il vous suffit de télécharger vos documents pour commencer. TradingGoose les traite automatiquement en arrière-plan, extrayant le texte, créant des embeddings et les divisant en segments consultables.
...
Pour les documents PDF, TradingGoose offre des capacités de traitement améliorées :
...
TradingGoose utilise la recherche vectorielle alimentée par [pgvector](https://github.com/pgvector/pgvector) pour comprendre le sens et le contexte de votre contenu :
