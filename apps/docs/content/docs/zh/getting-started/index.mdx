...
本教程将指导您在 TradingGoose 中构建第一个 AI 工作流。我们将创建一个可以使用最先进的 LLM-Search 工具查找个人信息的人员研究代理。

<Callout type="info">
  本教程大约需要 10 分钟，涵盖了在 TradingGoose 中构建工作流的基本概念。
</Callout>
...
<Steps>
  <Step title="创建工作流并添加 AI 代理">
    打开 TradingGoose 并在仪表板中点击“新建工作流”。将其命名为“入门指南”。
