...
<ShowcaseCard>
  <BlockConfigPreview
    ...
    hideHeader
    subBlocks={[
      { "id": "variables", "title": "Variable Assignments", "type": "variables-input", "layout": "full", "description": "Select workflow variables and update their values during execution. Access them anywhere using <variable.variableName> syntax." }
    ]}
  />
</ShowcaseCard>
