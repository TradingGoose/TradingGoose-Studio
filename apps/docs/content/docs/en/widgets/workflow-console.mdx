...
- **Export to CSV** -- downloads all console entries for the selected workflow as a CSV file; display filters do not limit the export
...
5. Click the download button to export all entries for the selected workflow as CSV for offline analysis, including entries hidden by display filters
