...
2. Select an existing indicator from the header dropdown, or create one in the [Indicator List](/indicators) widget first.
...
<Callout>
This widget supports the **pairColor** mechanism. Assign the same color to an Indicator Editor and an [Indicator List](/indicators) widget so that selecting an indicator in the list automatically opens it in the editor.
</Callout>
