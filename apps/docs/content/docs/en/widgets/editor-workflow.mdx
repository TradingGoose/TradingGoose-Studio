...
<Callout>
Pair this widget with **Console**, **Chat**, or **Variables** using matching pair colors. To give the global Copilot panel the same workflow context, choose that color from the Copilot header.
</Callout>
