...
<iframe
  ...
  title="Slack Integration with TradingGoose"
  frameBorder="0"
...
- **Automate agent notifications**: Send real-time updates from your TradingGoose agents to any Slack channel
- **Create webhook endpoints**: Configure Slack bots as webhooks to trigger TradingGoose workflows from Slack activities
...
In TradingGoose, the Slack integration enables your agents to programmatically interact with Slack in several ways as part of their workflows:
