...
<Cards>
  <Card title="Use as a Trigger" href="/triggers/hubspot">
    See trigger events, setup, and event payloads for HubSpot.
  </Card>
</Cards>
...
<div className="mt-6 border-t border-fd-border pt-4">
<div className="text-base font-semibold mb-2">Get Contacts (<code>hubspot_list_contacts</code>)</div>
...
<div className="mt-6 border-t border-fd-border pt-4">
<div className="text-base font-semibold mb-2">Get Companies (<code>hubspot_list_companies</code>)</div>
