...
Tools are powerful components in TradingGoose that allow your workflows to interact with external services, process data, and perform specialized tasks. They extend the capabilities of your agents and workflows by providing access to various APIs and services.
...
There are two primary ways to use tools in your TradingGoose workflows:
...
TradingGoose provides a diverse collection of tools for various purposes, including:
