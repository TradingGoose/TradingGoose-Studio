...
The official Python SDK for TradingGoose allows you to execute workflows programmatically from your Python applications using the official Python SDK.
...
- `base_url` (str, optional): Base URL for the TradingGoose API
