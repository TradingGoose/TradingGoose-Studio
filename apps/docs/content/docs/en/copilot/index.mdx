...
Copilot is your in-editor assistant that helps you build and edit workflows with TradingGoose Copilot, as well as understand and improve them. It can:

- **Explain**: Answer questions about TradingGoose and your current workflow
- **Guide**: Suggest edits and best practices
- **Edit**: Make changes to blocks, connections, and settings when you approve

<Callout type="info">
  Copilot is a TradingGoose-managed service. For self-hosted deployments, generate a Copilot API key in the hosted app (tradinggoose.ai → Settings → Copilot)
  1. Go to [tradinggoose.ai](https://tradinggoose.ai) → Settings → Copilot and generate a Copilot API key
...
- **Docs**: Reference TradingGoose Documentation
