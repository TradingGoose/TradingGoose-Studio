...
<div className="flex justify-center">
  <Image
    ...
    alt="TradingGoose visual workflow canvas"
    width={700}
    height={450}
    className="my-6"
  />
...
TradingGoose connects to 80+ services out of the box:
...
**Cloud-hosted**: Get started instantly at [tradinggoose.ai](https://tradinggoose.ai) with managed infrastructure, automatic scaling, and built-in monitoring.
