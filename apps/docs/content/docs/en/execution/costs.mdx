...
TradingGoose automatically calculates costs for all workflow executions, providing transparent pricing based on AI model usage and execution charges. Understanding these costs helps you optimize workflows and manage your budget effectively.
...
<Tabs items={['Hosted Models', 'Bring Your Own API Key']}>
  <Tab>
    **Hosted Models** - TradingGoose provides API keys with a 2.5x pricing multiplier:
...
|------|-------------------|-------------------------|
| **Free** | $10 | 10 sync, 50 async |
| **Pro** | $20 | 25 sync, 200 async |
| **Team** | $40/seat (pooled) | 75 sync, 500 async |
| **Enterprise** | Custom | 150 sync, 1000 async |

## Billing Model

TradingGoose uses a **base subscription + overage** billing model:
...
When unbilled overage reaches $50, TradingGoose automatically bills the full unbilled amount.
...
- Review your current usage in [Settings → Subscription](https://tradinggoose.ai/settings/subscription)
