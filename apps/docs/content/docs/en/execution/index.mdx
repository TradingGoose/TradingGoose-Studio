...
- Creates a unique HTTP endpoint: `https://tradinggoose.ai/api/workflows/{workflowId}/execute`
...
- Hosted on a custom subdomain: `https://your-name.tradinggoose.ai`
...
The Deploy modal keeps a full version history displayed in a table of deployment snapshots. You can inspect any snapshot, compare it against your draft, and promote or roll back with one click when you need to restore a prior release.
...
- Cache results with Variables blocks when appropriate
