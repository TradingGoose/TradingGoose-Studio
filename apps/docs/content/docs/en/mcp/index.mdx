...
The Model Context Protocol ([MCP](https://modelcontextprotocol.com/)) allows you to connect external tools and services using a standardized protocol, enabling you to integrate APIs and services directly into your workflows. With MCP, you can extend TradingGoose's capabilities by adding custom integrations that work seamlessly with your agents and workflows.
...
### API Integrations
Access external APIs and web services that don't have built-in TradingGoose integrations.
