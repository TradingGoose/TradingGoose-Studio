...
Welcome to TradingGoose, a visual workflow builder for AI applications. Build powerful AI agents, automation workflows, and data processing pipelines by connecting blocks on a canvas.

## Quick Start

<Cards>
  <Card title="Introduction" href="/introduction">
    Learn what you can build with TradingGoose
  </Card>
