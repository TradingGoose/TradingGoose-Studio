---
title: Evaluator
description: Score and assess content quality with AI
---
...
4. **Return scores** - Returns numeric scores under lowercase metric names; no separate natural-language evaluation summary is returned.
...
<Tabs items={['Configuration', 'Variables', 'Results']}>
  ...
  <Tab>
    <ul className="list-disc space-y-2 pl-6">
      <li>
        <strong>Metric Scores</strong>: Numeric outputs keyed by lowercase metric names
      </li>
      <li>
