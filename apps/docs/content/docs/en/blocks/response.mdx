---
title: Response
description: Format and return structured API responses
---
...
<Callout type="warning">
  Response does not control webhook acknowledgments. Webhook endpoints enqueue the workflow and acknowledge the request before execution finishes. Response can shape workflow output, but its status, headers, and body are not returned as that webhook acknowledgment.
</Callout>
