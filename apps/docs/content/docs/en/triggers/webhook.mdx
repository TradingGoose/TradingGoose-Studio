...
Webhooks allow external services to trigger workflow execution from external webhooks by sending HTTP requests to your workflow. TradingGoose supports two approaches for webhook-based triggers.
