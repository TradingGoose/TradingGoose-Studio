...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className='z-20 flex h-2/3 w-[3px] items-center justify-center rounded-sm bg-border group-data-[panel-group-direction=vertical]:h-[3px] group-data-[panel-group-direction=vertical]:w-2/3'>
