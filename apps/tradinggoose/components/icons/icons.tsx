...
export function FacebookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='1em' height='1em' fill='currentColor' {...props}>
      <path d='M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 1.092.032 1.543.076v3.287h-1.2c-1.604 0-2.225.603-2.225 2.176v2.019h3.289l-.564 3.667h-2.725v8.127C19.396 22.15 23 17.533 23 12.069c0-6.069-4.882-10.99-10.915-11.065C5.892.93.912 5.736.836 11.929c-.076 6.193 4.717 11.262 10.912 11.338.13.002.258.002.388 0l-.035-.576z' />
    </svg>
  )
}