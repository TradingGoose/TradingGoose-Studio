  ...
  return (
    <LegalLayout title='Join Our Team'>
      <div className={`${soehne.className} mx-auto max-w-2xl`}>
        {/* Form Section */}
        <section className='rounded-2xl border border-gray-200 p-6 shadow-sm sm:p-10'>
          ...
          <form onSubmit={onSubmit} className='space-y-5'>
            ...
            <div className='flex justify-end pt-2'>
              <Button
                ...
                className='min-w-[200px] rounded-md border border-[#6F3DFA] bg-gradient-to-b from-[#8357FF] to-[#6F3DFA] text-white shadow-[inset_0_2px_4px_0_#9B77FF] transition-all duration-300 hover:opacity-90 disabled:opacity-50'
                size='lg'
              >
                {isSubmitting ? (
                  <>
