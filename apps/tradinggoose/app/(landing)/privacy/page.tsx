...
export default function PrivacyPolicy() {
  ...
  return (
    <LegalLayout title='Privacy Policy'>
      <div className="p-12 border border-border rounded-2xl bg-muted/50  text-accent-foreground prose prose-gray mx-auto prose-h2:mt-12 prose-h3:mt-8 prose-h2:mb-6 prose-h3:mb-4 space-y-8">
        <section>
