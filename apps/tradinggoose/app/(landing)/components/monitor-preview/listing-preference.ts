...
export const PREFERRED_MARKET_CODES = ['NASDAQ', 'HKEX', 'LSE', 'NYSE', 'SHE'] as const
...
const PREFERRED_MARKET_RANK = new Map<string, number>(
  PREFERRED_MARKET_CODES.map((code, index) => [code, index])
)
