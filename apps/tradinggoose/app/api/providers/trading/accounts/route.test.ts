...
describe('Trading provider accounts route', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('rejects invalid JSON payloads', async () => {
    const { POST } = await import('@/app/api/providers/trading/accounts/route')
    const request = new NextRequest('http://localhost/api/providers/trading/accounts', {
      method: 'POST',
