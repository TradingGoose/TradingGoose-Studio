...
export function WorkspaceApiKeysPage() {
  ...
  const headerLeft = (
    <div className='flex w-full flex-1 items-center gap-3'>
      <div className='hidden items-center gap-2 sm:flex'>
        ...
        <span className='font-medium text-sm'>{apiKeysCopy.title}</span>
      </div>
  ...
  const headerRight = (
    ...
    >
      ...
      <span>{keyScope === 'workspace' ? apiKeysCopy.create.workspace : apiKeysCopy.create.personal}</span>
    </PrimaryButton>
  )
