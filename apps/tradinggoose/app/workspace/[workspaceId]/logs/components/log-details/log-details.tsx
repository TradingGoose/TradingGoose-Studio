...
export function LogDetails({
  ...
  const traceSpanCostMultiplier = useMemo(() => {
    ...
    return getTraceSpanDisplayCostMultiplier(
        ...
        <div className="min-h-0 flex-1">
          ...
          >
            <div className="flex w-full flex-col gap-3 px-3 pt-4 pb-4">
              ...
              {log.executionData?.toolCalls &&
                log.executionData.toolCalls.length > 0 && (
                  ...
                  <div className="overflow-hidden rounded-md border">
                    ...
                    <div className="flex flex-col gap-2 p-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-muted-foreground text-xs">
                          {log.cost?.tokens?.prompt || 0} in /{" "}
                          {log.cost?.tokens?.completion || 0} out
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Models Breakdown */}
                    {log.cost?.models &&
                      Object.keys(log.cost?.models).length > 0 && (
                        <div className="border-t">
                          <button
                            onClick={() =>
                          ...
                          >
                            <span className="font-medium text-muted-foreground text-xs">
                              Model Breakdown (
                              {Object.keys(log.cost?.models || {}).length})
                            </span>
                            {isModelsExpanded ? (
                    ...
                    <div className="border-t bg-muted/40 p-2 text-[11px] text-muted-foreground">
                      <p>
                        ...
                        {formatCost(baseExecutionCharge)} plus any model usage
                        costs.
                      </p>
                    </div>
                  </div>
