...
export const hubspotCompanyPropertyChangedTrigger: TriggerConfig = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      defaultValue: hubspotSetupInstructions(
        ...
        'The webhook will trigger whenever any property of a company is updated. You can optionally filter by a specific property name to only receive events for that property. The webhook provides both the property name and new value in the payload.'
      ),
      mode: 'trigger',
      condition: {
        field: 'selectedTriggerId',
  ...
  -d '{
    ...
    "active": true
      ...
      defaultCollapsed: true,
      showCopyButton: true,
      description: 'Run this command to subscribe to company property change events',
      mode: 'trigger',
      condition: {
        field: 'selectedTriggerId',
        value: 'hubspot_company_property_changed',
  ...
  outputs: buildCompanyPropertyChangedOutputs(),
