...
export const hubspotContactCreatedTrigger: TriggerConfig = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      defaultValue: hubspotSetupInstructions(
        'contact.creation',
        'The webhook will trigger whenever a new contact is created in your HubSpot account, regardless of the source (manual entry, form submission, API, import, etc.).'
      ),
      mode: 'trigger',
      condition: {
        field: 'selectedTriggerId',
  ...
  -d '{
    ...
    "active": true
      ...
      defaultCollapsed: true,
      showCopyButton: true,
      description: 'Run this command to subscribe to contact creation events',
      mode: 'trigger',
      condition: {
        field: 'selectedTriggerId',
        value: 'hubspot_contact_created',
  ...
  outputs: buildContactCreatedOutputs(),
