...
export const GenericWebhookBlock: BlockConfig = {
  ...
  bestPractices: `
  - You can test the webhook by sending a request to the webhook URL. E.g. depending on authorization:  curl -X POST http://localhost:3000/api/webhooks/trigger/d8abcf0d-1ee5-4b77-bb07-b1e8142ea4e9 -H "Content-Type: application/json" -H "X-TradingGoose-Secret: 1234" -d '{"message": "Test webhook trigger", "data": {"key": "v"}}'
  ...
  - Only use when there's no existing integration trigger for the service.
  `,
