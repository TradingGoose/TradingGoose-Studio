...
export const useMcpEditorActions = createEditorActionsHook<McpAction>(MCP_EDITOR_ACTION_EVENT)

export const emitMcpEditorAction = createEmitEditorAction<McpAction>(MCP_EDITOR_ACTION_EVENT)
