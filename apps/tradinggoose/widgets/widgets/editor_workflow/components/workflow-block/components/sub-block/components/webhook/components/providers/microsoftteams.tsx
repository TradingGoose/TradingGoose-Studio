...
import {
  ...
  InstructionsSection,
  TestResultDisplay,
} from '@/widgets/widgets/editor_workflow/components/workflow-block/components/sub-block/components/webhook/components'
  ...
  return (
    <div className='space-y-4'>
      ...
      <InstructionsSection
        ...
        tip='Create an outgoing webhook in Teams to receive messages from Teams in TradingGoose.'
      >
        <ol className='list-inside list-decimal space-y-1'>
          ...
          <li>Set the callback URL to your TradingGoose webhook URL (shown above).</li>
      ...
      <InstructionsSection title='Receiving Messages from Teams'>
        <p>
          ...
          to your TradingGoose webhook URL with a payload like this:
        </p>
      ...
      <Alert>
        ...
        <AlertDescription>
          <ul className='mt-1 list-outside list-disc space-y-1 pl-4'>
            <li>Your TradingGoose webhook URL must use HTTPS and be publicly accessible.</li>
