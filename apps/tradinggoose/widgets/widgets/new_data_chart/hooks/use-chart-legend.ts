...
import type { DataChartViewParams, NewDataChartDataContext } from '@/widgets/widgets/new_data_chart/types'
...
const resolveBarAtIndex = (dataContext: NewDataChartDataContext, index?: number | null) => {
