...
import { DEFAULT_BAR_COUNT, intervalToMs } from '@/widgets/widgets/new_data_chart/series-data'
import { rangeToMs } from '@/widgets/widgets/new_data_chart/series-window'
