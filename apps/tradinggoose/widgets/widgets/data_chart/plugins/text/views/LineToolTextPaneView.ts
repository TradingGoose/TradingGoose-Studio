...
import { isInlineEditorActiveForTool } from '../../core/model/inline-editor-state'
import { TrendLineOptionDefaults } from '../../shared/lines/model/LineToolTrendLine'
import type { LineToolText } from '../model/LineToolText'
...
export class LineToolTextPaneView<HorzScaleItem> extends LineToolPaneView<HorzScaleItem> {
   ...
   * @private
   */
  private _compositeRenderer: CompositeRenderer<HorzScaleItem> =
    new CompositeRenderer<HorzScaleItem>()
  ...
  protected override _updateImpl(height: number, width: number): void {
    ...
    const inlineEditorActive = isInlineEditorActiveForTool(this._tool.id())
