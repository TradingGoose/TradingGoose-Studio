...
import type { LineToolParallelChannel } from '../model/LineToolParallelChannel'
import {
  ParallelChannelRenderer,
  type ParallelChannelRendererData,
} from '../rendering/ParallelChannelRenderer'
 ...
 */
export class LineToolParallelChannelPaneView<
  HorzScaleItem,
> extends LineToolPaneView<HorzScaleItem> {
  ...
  protected override _addAnchors(renderer: CompositeRenderer<HorzScaleItem>): void {
    ...
    const getScreenPoint = (index: number): AnchorPoint => {
      ...
      const screenPoint = logicalPoint
        ? tool.pointToScreenPoint(logicalPoint)!
