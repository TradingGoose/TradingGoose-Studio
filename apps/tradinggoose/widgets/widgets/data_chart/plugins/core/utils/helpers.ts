...
function colorStringToRgba(colorString: string): Rgba {
  ...
  if (matches) {
    return [
      Number.parseInt(matches[1], 10) as RedComponent,
      Number.parseInt(matches[2], 10) as GreenComponent,
      Number.parseInt(matches[3], 10) as BlueComponent,
      Number.parseFloat(matches[4]) as AlphaComponent,
    ]
  }
  ...
  if (matches) {
    return [
      Number.parseInt(matches[1], 16) as RedComponent,
      Number.parseInt(matches[2], 16) as GreenComponent,
      Number.parseInt(matches[3], 16) as BlueComponent,
      1 as AlphaComponent,
    ]
  }
  ...
  if (matches) {
    return [
      Number.parseInt(matches[1] + matches[1], 16) as RedComponent,
      Number.parseInt(matches[2] + matches[2], 16) as GreenComponent,
      Number.parseInt(matches[3] + matches[3], 16) as BlueComponent,
      1 as AlphaComponent,
    ]
  }
 ...
 */
export function randomHash(count = 12): string {
  let hash = ''
