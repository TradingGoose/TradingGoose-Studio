...
import type { TextWidthCache as ITextWidthCache } from '../types' // Import the interface
 ...
 */
export type CanvasCtxLike = Pick<
  CanvasRenderingContext2D,
  'measureText' | 'save' | 'restore' | 'textBaseline'
>
