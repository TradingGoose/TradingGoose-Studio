...
export class LineToolPriceRange<HorzScaleItem> extends BaseLineTool<HorzScaleItem> {
  ...
  public constructor(
    ...
    options: DeepPartial<LineToolOptionsInternal<'PriceRange'>> | undefined,
  ...
  public override getPoint(index: number): LineToolPoint | null {
    ...
    switch (index) {
      ...
      case 2:
        return { price: P1.price, timestamp: P0.timestamp } // P0 Time, P1 Price
      case 3:
        return { price: P0.price, timestamp: P1.timestamp } // P1 Time, P0 Price

      // Side Anchors (Topology: One fixed axis, one Midpoint)
      case 4:
        return { price: midPrice, timestamp: P0.timestamp } // Left/Right (P0 Time)
      case 5:
        return { price: midPrice, timestamp: P1.timestamp } // Left/Right (P1 Time)
      case 6:
        return { price: P0.price, timestamp: midTime } // Top/Bottom (P0 Price)
      case 7:
        return { price: P1.price, timestamp: midTime } // Top/Bottom (P1 Price)
  ...
  public override getShiftConstrainedPoint(
    ...
    if (pointIndex === 4 || pointIndex === 5) {
      // Vertical Lines (Move Horizontal)
      return {
    ...
    if (pointIndex === 6 || pointIndex === 7) {
      // Horizontal Lines (Move Vertical)
      return {
