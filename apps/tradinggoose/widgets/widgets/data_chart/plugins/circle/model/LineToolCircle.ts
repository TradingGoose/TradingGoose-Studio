...
export class LineToolCircle<HorzScaleItem> extends BaseLineTool<HorzScaleItem> {
  ...
  private _getAnchorPointForIndex(index: number): LineToolPoint | null {
    ...
    switch (index) {
      case 2:
        return { timestamp: minTime, price: minPrice } // Bottom-Left Corner (BL)
      case 3:
        return { timestamp: maxTime, price: maxPrice } // Top-Right Corner (TR)
      case 4:
        return { timestamp: minTime, price: maxPrice } // Top-Left Corner (TL)
      case 5:
        return { timestamp: maxTime, price: minPrice } // Bottom-Right Corner (BR)
      case 6:
        return { timestamp: midTime, price: maxPrice } // Top-Center Midpoint (TC)
      case 7:
        return { timestamp: midTime, price: minPrice } // Bottom-Center Midpoint (BC)
   ...
   */
  private _toVerticalRadiusPoint(
    center: LineToolPoint,
    radiusCandidate: LineToolPoint
  ): LineToolPoint {
    return {
