...
import type { LineToolCircle } from '../model/LineToolCircle'
...
export class LineToolCirclePaneView<HorzScaleItem> extends LineToolPaneView<HorzScaleItem> {
  ...
  public constructor(
    ...
    this._circleRenderer = new CircleRenderer<HorzScaleItem>(
      ...
      new HitTestResult<LineToolHitTestData>(HitTestType.MovePointBackground, {
        pointIndex: null,
  ...
  protected override _updateImpl(height: number, width: number): void {
     ...
     */
    if (
      this._tool.getPermanentPointsCount() >= this._tool.pointsCount &&
