...
import type { LineToolMarketDepth } from '../model/LineToolMarketDepth'
import { MarketDepthRenderer, type MarketDepthRendererData } from '../rendering/MarketDepthRenderer'
...
export class LineToolMarketDepthPaneView<HorzScaleItem> extends LineToolPaneView<HorzScaleItem> {
   ...
   * @protected
   */
  protected _anchorLabelRenderer: TextRenderer<HorzScaleItem> = new TextRenderer(
    new HitTestResult(HitTestType.Regular)
  )
