...
export const widgetHeaderMenuItemClassName =
  'group flex w-full cursor-pointer items-center gap-1 rounded-sm px-2 py-1.5 font-medium text-muted-foreground text-sm outline-none transition-colors hover:bg-card focus:bg-muted disabled:cursor-not-allowed disabled:opacity-60 data-[disabled]:cursor-not-allowed data-[disabled]:opacity-60 '
